...
#define SHKMyAppName			@"Pond Hopper"
#define SHKMyAppURL				@"http://pondhopper.shawnsbits.com"
...
#define SHKFacebookKey				@"1481aa918c2c6c4bea519405372ec19f"
#define SHKFacebookSecret			@"71cc87ab4e3a456dd13c3f4f4c25d346"
 ...
 */
#define SHKTwitterConsumerKey		@"eN5qRhAHAREdpaooXrNybw"
#define SHKTwitterSecret			@"kxccknEvRbhR3fdpmtPTZGeg8cS84Nf8YRO7fX2nw"
#define SHKTwitterCallbackUrl		@"http://pondhopperapp.com/scores" // You need to set this if using OAuth, see note above (xAuth users can skip it)
...
//#define SHKLog( s, ... ) CCLOG( @"<%p %@:(%d)> %@", self, [[NSString stringWithUTF8String:__FILE__] lastPathComponent], __LINE__, [NSString stringWithFormat:(s), ##__VA_ARGS__] )
